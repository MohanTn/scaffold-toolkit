/**
 * Shared fixture helpers for adapter-claude-code's integration tests.
 * Mirrors packages/adapter-copilot-cli/test/_harness.mjs's own mirror of
 ...
 * child env objects that prepend that tmpdir to PATH. See
 * packages/adapter-copilot-cli/test/_harness.mjs's identical helper for the
 * full rationale (a shell wrapper, not a symlink, for cross-runner safety).
 */
